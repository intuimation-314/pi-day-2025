...
class PiThumbnail(Scene):
    def construct(self):
        ...
        title = Tex(r"$\mathbb{T}$he\ $\mathbb{Q}$uest\ for\ $\mathbb{P}$I").set_color_by_gradient(BLUE, TEAL).to_edge(UP).scale(1.6)
        ...
        formula2 = MathTex(r"\frac{\pi}{4} = 4\tan^{-1} \frac{1}{5} - \tan^{-1} \frac{1}{239}").scale(0.7).next_to(phase2, UP).shift(LEFT)
        ...
        self.add(title, image_group, formula_group)
